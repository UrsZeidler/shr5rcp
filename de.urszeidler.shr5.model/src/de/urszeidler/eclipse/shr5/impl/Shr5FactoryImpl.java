...
public class Shr5FactoryImpl extends EFactoryImpl implements Shr5Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Shr5Package.MUDAN_CRITTER: return createMudanCritter();
			case Shr5Package.CRITTER_KRAFT: return createCritterKraft();
			case Shr5Package.PARA_CRITTER: return createParaCritter();
	 ...
	 * @generated
	 */
	public MudanCritter createMudanCritter() {
		MudanCritterImpl mudanCritter = new MudanCritterImpl();
		return mudanCritter;
	}
	 ...
	 * @generated
	 */
	public ParaCritter createParaCritter() {
		ParaCritterImpl paraCritter = new ParaCritterImpl();
		return paraCritter;
	}
