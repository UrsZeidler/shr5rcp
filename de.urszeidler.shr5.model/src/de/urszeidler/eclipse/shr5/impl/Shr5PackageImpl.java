...
public class Shr5PackageImpl extends EPackageImpl implements Shr5Package {
	 ...
	 * @generated
	 */
	private EClass mudanCritterEClass = null;
	 ...
	 * @generated
	 */
	private EClass paraCritterEClass = null;
	 ...
	 * @generated
	 */
	public EClass getMudanCritter() {
		return mudanCritterEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMudanCritter_Kraefte() {
		return (EReference)mudanCritterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getParaCritter() {
		return paraCritterEClass;
	}
	...
	public void createPackageContents() {
		...
		mudanCritterEClass = createEClass(MUDAN_CRITTER);
		createEReference(mudanCritterEClass, MUDAN_CRITTER__KRAEFTE);
		...
		paraCritterEClass = createEClass(PARA_CRITTER);
	...
	public void initializePackageContents() {
		...
		mudanCritterEClass.getESuperTypes().add(this.getKoerperPersona());
		critterKraftEClass.getESuperTypes().add(this.getMagischeMods());
		paraCritterEClass.getESuperTypes().add(this.getMudanCritter());
		paraCritterEClass.getESuperTypes().add(this.getBaseMagischePersona());
		...
		initEClass(mudanCritterEClass, MudanCritter.class, "MudanCritter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMudanCritter_Kraefte(), this.getCritterKraft(), null, "kraefte", null, 0, -1, MudanCritter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(paraCritterEClass, ParaCritter.class, "ParaCritter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
