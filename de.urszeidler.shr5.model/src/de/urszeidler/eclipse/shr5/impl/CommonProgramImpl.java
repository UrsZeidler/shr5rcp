    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Identifiable.class) {
            switch (derivedFeatureID) {
                ...
                case Shr5Package.COMMON_PROGRAM__LOCALIZATIONS: return Shr5Package.IDENTIFIABLE__LOCALIZATIONS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Identifiable.class) {
            switch (baseFeatureID) {
                ...
                case Shr5Package.IDENTIFIABLE__LOCALIZATIONS: return Shr5Package.COMMON_PROGRAM__LOCALIZATIONS;
                default: return -1;
            }
        }
        if (baseClass == Quelle.class) {
