 ...
 *   <li>{@link de.urszeidler.eclipse.shr5.impl.VertragImpl#getLocalizations <em>Localizations</em>}</li>
...
public class VertragImpl extends MinimalEObjectImpl.Container implements Vertrag {
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Shr5Package.VERTRAG__LOCALIZATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Identifiable.class) {
            switch (derivedFeatureID) {
                ...
                case Shr5Package.VERTRAG__LOCALIZATIONS: return Shr5Package.IDENTIFIABLE__LOCALIZATIONS;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Identifiable.class) {
            switch (baseFeatureID) {
                ...
                case Shr5Package.IDENTIFIABLE__LOCALIZATIONS: return Shr5Package.VERTRAG__LOCALIZATIONS;
                default: return -1;
            }
        }
        if (baseClass == Quelle.class) {
