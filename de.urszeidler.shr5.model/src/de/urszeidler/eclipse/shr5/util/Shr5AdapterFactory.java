...
public class Shr5AdapterFactory extends AdapterFactoryImpl {
	...
	protected Shr5Switch<Adapter> modelSwitch =
		new Shr5Switch<Adapter>() {
			...
			@Override
			public Adapter caseMudanCritter(MudanCritter object) {
				return createMudanCritterAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseParaCritter(ParaCritter object) {
				return createParaCritterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.urszeidler.eclipse.shr5.MudanCritter <em>Mudan Critter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.urszeidler.eclipse.shr5.ParaCritter <em>Para Critter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
