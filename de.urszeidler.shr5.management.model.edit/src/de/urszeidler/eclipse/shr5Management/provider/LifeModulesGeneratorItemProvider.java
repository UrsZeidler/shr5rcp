        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LifeModulesGenerator_nationality_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LifeModulesGenerator_nationality_feature", "_UI_LifeModulesGenerator_type"),
                 Shr5managementPackage.Literals.LIFE_MODULES_GENERATOR__NATIONALITY,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addFormativeYearsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LifeModulesGenerator_formativeYears_feature"),
                 ...
                 Shr5managementPackage.Literals.LIFE_MODULES_GENERATOR__FORMATIVE_YEARS,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addTeenYearsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_LifeModulesGenerator_teenYears_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_LifeModulesGenerator_teenYears_feature", "_UI_LifeModulesGenerator_type"),
                 Shr5managementPackage.Literals.LIFE_MODULES_GENERATOR__TEEN_YEARS,
                 true,
                 false,
                 true,
                 null,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 getString("_UI_PropertyDescriptor_description", "_UI_LifeModulesGenerator_furtherEducation_feature", "_UI_LifeModulesGenerator_type"),
                 Shr5managementPackage.Literals.LIFE_MODULES_GENERATOR__FURTHER_EDUCATION,
                 true,
                 false,
                 true,
                 null,
