...
public class ConnectionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addLoyalityPropertyDescriptor(object);
    ...
    public Object getImage(Object object) {
        ...
        if (factory != null && connection.getCharacter() != null) {
            IItemLabelProvider labelprovider = (IItemLabelProvider) factory.adapt(connection.getCharacter(),
                    IItemLabelProvider.class);
            if (labelprovider != null)
                return labelprovider.getImage(connection.getCharacter());
        }
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_Connection_type") + " " + label + " [" + connection.getInfluence() + "/" + connection.getLoyality() + "]";
    }
