...
//        Object object = event.data;
        ...
        grpRest.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false, 1, 1));
...
//        });
//         
//        tableViewer.setContentProvider(new  SimpleListContenProvider(new AdapterFactoryContentProvider(AdapterFactoryUtil.getInstance().getAdapterFactory())));
...
//    }
    ...
    protected DataBindingContext initDataBindings() {
        ...
        IObservableValue observeValue = EMFObservables.observeValue(bindingContext.getValidationRealm(), runtimeCharacter.getCharacter().getPersona(),
        ...
        IObservableValue characterNameObserveValue = EMFObservables.observeValue(bindingContext.getValidationRealm(), runtimeCharacter.getCharacter().getPersona(),
