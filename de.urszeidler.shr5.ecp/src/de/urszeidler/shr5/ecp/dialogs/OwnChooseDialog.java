...
public class OwnChooseDialog extends SelectionDialog {
    ...
    private WritableValue filterExpression = new WritableValue();
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        filterExpression.addValueChangeListener(new IValueChangeListener() {

            @Override
            public void handleValueChange(ValueChangeEvent event) {
                patternFilter.setPattern((String)event.diff.getNewValue());
                tree.setFilters(filters);
            }
        });
    ...
    protected DataBindingContext initDataBindings() {
        ...
        //
        IObservableValue observeTextTxtFiltertxtObserveWidget = WidgetProperties.text(SWT.Modify).observeDelayed(200, txtFiltertxt);
