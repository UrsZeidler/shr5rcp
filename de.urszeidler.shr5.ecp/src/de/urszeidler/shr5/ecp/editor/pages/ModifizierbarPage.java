...
public class ModifizierbarPage extends AbstractShr5Page<Modifizierbar> {
    ...
    public ModifizierbarPage(FormEditor editor, String id, String title, Modifizierbar object) {
        super(editor, id, title);
        this.object = object;

    }

    public ModifizierbarPage(FormEditor editor, String id, String title, Modifizierbar object, EditingDomain editingDomain, ReferenceManager manager) {
