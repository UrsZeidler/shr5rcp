...
public class Shr5GeneratorPage extends AbstractShr5Page<Shr5Generator> {
	...
	//
	// /**
	// * Calculates the resources left.
	// *
	// * @author urs
	// *
	// */
	// public class ResourceLeft extends Converter {
	// public ResourceLeft() {
	...
	//
	// int resourceKosten = object.getKarmaToResource() *
	// object.getShr5Generator().getKarmaToResourceFactor();
	//
	// Integer value = (Integer) fromObject;
	// if (object.getResourcen() != null)
	// value = object.getResourcen().getResource() - value;
	//
	// value = value + resourceKosten;
	...
	// *
	// */
	// public class AttributesLeft extends Converter {
	// public AttributesLeft() {
	// super(Integer.class, String.class);
	// }
	//
	// @Override
	...
	// value = object.getAttribute().getAttibutePoints() - value;
	//
	// return value.toString();
	// }
	// }
	...
	// *
	// */
	// public class KarmaLeft extends Converter {
	// public KarmaLeft() {
	// super(Integer.class, String.class);
	// }
	//
	...
	// value = object.getShr5Generator().getKarmaPoints() - value;
	//
	// return value.toString();
	// }
	// }
	...
	// *
	// */
	// public class SkillLeft extends Converter {
	// public SkillLeft() {
	// super(Integer.class, String.class);
	// }
	//
	...
	// value = object.getSkills().getSkillPoints() - value;
	//
	// return value.toString();
	// }
	// }
	...
	// *
	// */
	// public class SkillGroupLeft extends Converter {
	// public SkillGroupLeft() {
	// super(Integer.class, String.class);
	// }
	//
	// @Override
	...
	// Integer value = (Integer) fromObject;
	// if (object.getSkills() != null)
	// value = object.getSkills().getGroupPoints() - value;
	//
	// return value.toString();
	// }
	// }
	 ...
	 * @param manager
	 */
	public Shr5GeneratorPage(FormEditor editor, String id, String title, Shr5Generator object, EditingDomain editingDomain,
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		lblTtt = managedForm.getToolkit().createLabel(composite_1, "ttt", SWT.NONE);
		...
		emfFormBuilder
				.addTextEntry("Gruppe", Shr5managementPackage.Literals.CHARACTER_GENERATOR__SELECTED_GROUP, composite_group);

		emfFormBuilder.addTextEntry("Name", Shr5managementPackage.Literals.CHARACTER_GENERATOR__CHARACTER_NAME,
				composite_overview);
		emfFormBuilder.addTextEntry("Generator", Shr5managementPackage.Literals.CHARACTER_GENERATOR__GENERATOR,
				composite_overview);
	...
	private void updateDecorator(Set<Integer> newSet) {
		...
		if (newSet.contains(Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_SPECIAL_POINTS)) {
			controlDecorationMetaTyp.setDescriptionText("Not all attributes spend.");
		...
		if (newSet.contains(Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_SPECIAL_TYPE_POINTS)) {
			controlDecorationMagic.setDescriptionText("Not all attributes spend.");
	...
	private void addPersonaPage(ManagedCharacter playerCharacter) {
		try {
			...
			Shr5GeneratorPage.this.getEditor().addPage(
					1,
					new AbstraktPersonaPage(Shr5GeneratorPage.this.getEditor(), "persona", "AbstractPersona", playerCharacter
							.getPersona(), editingDomain, mananger));
			Shr5GeneratorPage.this.getEditor().addPage(
					2,
					new ManagedCharacterPage(Shr5GeneratorPage.this.getEditor(), "character", "Inventar", playerCharacter,
	...
	private void createOptionWidgets() {
		...
		attributeGeneratorOption = new AttributeGeneratorOption(grpAttribute, SWT.NONE, object.getAttribute(),
				object.getCharacter(), getManagedForm().getToolkit(), editingDomain);
		...
		resourceGeneratorOption = new ResourceGeneratorOption(grpResourcen, SWT.NONE, object.getResourcen(),
				object.getCharacter(), getManagedForm().getToolkit(), editingDomain);
		resourceGeneratorOption.layout();

		if (metaTypGeneratorOption != null)
			metaTypGeneratorOption.dispose();
		metaTypGeneratorOption = new MetaTypGeneratorOption(grpMetatyp, SWT.NONE, object.getMetaType(), object.getCharacter(),
				getManagedForm().getToolkit(), editingDomain);
		metaTypGeneratorOption.layout();

		if (magicGeneratorOption != null)
			magicGeneratorOption.dispose();
		magicGeneratorOption = new MagicGeneratorOption(grpMagic, SWT.NONE, object.getMagic(), object.getCharacter(),
				getManagedForm().getToolkit(), editingDomain);
	...
	protected DataBindingContext initDataBindings() {
		...
		bindingContext.bindValue(observeSelectionSpinnerObserveWidget, objectKarmaToResourceObserveValue,
		...
		IObservableValue objectStateObserveValue = EMFEditObservables.observeValue(editingDomain, object,
		...
		//
		//
		IObservableValue observeTextLblTttObserveWidget = WidgetProperties.text().observe(lblTtt);
		IObservableValue currentInstructionObjectObserveValue = PojoProperties.value("currentInstruction").observe(object);
		bindingContext.bindValue(observeTextLblTttObserveWidget, currentInstructionObjectObserveValue, new UpdateValueStrategy(
	...
	private void ownBinding(DataBindingContext bindingContext) {
		...
		objectKarmaSpendObserveValue = EMFEditObservables.observeValue(editingDomain, object,
				Literals.SHR5_GENERATOR__KARMA_SPEND);
