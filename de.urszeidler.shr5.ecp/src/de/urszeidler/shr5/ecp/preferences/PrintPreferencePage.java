...
public class PrintPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public void createFieldEditors() {
        ...
        addField(new StringFieldEditor(PreferenceConstants.CURRENCY_SYMBOL, "currency symbol", -1, StringFieldEditor.VALIDATE_ON_KEY_STROKE,
                getFieldEditorParent()));
        addField(new BooleanFieldEditor(PreferenceConstants.PRINT_PERSONA_DECRIPTION, "print persona description", BooleanFieldEditor.DEFAULT,
                getFieldEditorParent()));
        addField(new BooleanFieldEditor(PreferenceConstants.PRINT_USEABLE_SKILLS, "print all usable skills", BooleanFieldEditor.DEFAULT,
                getFieldEditorParent()));
        addField(new BooleanFieldEditor(PreferenceConstants.PRINT_CHARACTER_ADVACEMENTS, "print character advacements", BooleanFieldEditor.DEFAULT,
                getFieldEditorParent()));
        {
            ScaleFieldEditor scaleFieldEditor = new ScaleFieldEditor(PreferenceConstants.FOOTER_GAP, "Footer gab", getFieldEditorParent(), 10, 32, 1,
                    10);
            addField(scaleFieldEditor);
        }
        {
            ScaleFieldEditor scaleFieldEditor = new ScaleFieldEditor(PreferenceConstants.PAGE_MARGIN, "Page margin", getFieldEditorParent(), 0, 100,
                    1, 10);
