...
/**
 * Used for wrapping objects that define their own implementations of <code>equals()</code> and <code>hashCode()</code> when putting them in sets or
 * hashmaps to ensure identity comparison.
 * 
 * @author lobas_av
 */
