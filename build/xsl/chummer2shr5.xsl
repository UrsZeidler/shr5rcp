...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<shr5:ShrList xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI"
			...
			<entries xsi:type="shr5mngt:ShrMgmtList" name="Generators">
    ...
    <entries xsi:type="shr5mngt:CharacterGroup" name="player group">
      <members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.5" choosenLifestyle="//@entries.1/@entries.0/@members.0/@contracts.0" nativeLanguage="//@entries.0/@entries.5/@entries.8" sex="male">
        <persona xsi:type="shr5:KiAdept" image="/shr5Resource/images/gunter-face-small.png" name="Gu" edgeBasis="5" konstitutionBasis="5" geschicklichkeitBasis="6" reaktionBasis="5" staerkeBasis="4" charismaBasis="3" willenskraftBasis="3" intuitionBasis="4" logikBasis="2" spezies="//@entries.0/@entries.2/@entries.0" magieBasis="6">
          ...
          <fertigkeiten fertigkeit="//@entries.0/@entries.5/@entries.69"/>
          <fertigkeiten fertigkeit="//@entries.0/@entries.5/@entries.11"/>
        ...
        <changes xsi:type="shr5mngt:PersonaChange" date="2014-02-13T22:41:55.000+0100" changeApplied="true" dateApplied="2014-02-13T22:41:22.800+0100" from="1" to="2" changeable="//@entries.1/@entries.0/@members.0/@persona/@fertigkeiten.8"/>
        <changes xsi:type="shr5mngt:PersonaChange" date="2072-02-19T22:41:55.000+0100" changeApplied="true" dateApplied="2014-02-13T22:43:27.359+0100" from="2" to="3" changeable="//@entries.1/@entries.0/@members.0/@persona/@fertigkeiten.8"/>
        ...
        <inventar xsi:type="shr5:Nahkampfwaffe" page="422" srcBook="//@entries.0/@entries.0/@entries.0" wert="1000" verfuegbarkeit="9R" name="Katana" image="/shr5Resource/images/katana.png" schadenscode="(STR+3)P" praezision="7" durchschlagsKraft="-3"/>
        ...
        <inventar xsi:type="shr5:Gegenstand" page="448" srcBook="//@entries.0/@entries.0/@entries.0" wert="250" verfuegbarkeit="2" name="Miniwelder" image="/shr5Resource/images/Aliens-Portable-Hand-Welder-1.jpg" kategorie="B&amp;E Gear"/>
    ...
    <entries xsi:type="shr5mngt:CharacterGroup" name="non player group">
      <members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.2" sex="male">
      ...
      <members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.3" nativeLanguage="//@entries.0/@entries.5/@entries.6" sex="male">
        <persona xsi:type="shr5:MudanPersona" name="Rob" edgeBasis="1" konstitutionBasis="9" geschicklichkeitBasis="4" reaktionBasis="3" staerkeBasis="11" charismaBasis="3" willenskraftBasis="4" intuitionBasis="3" logikBasis="3" spezies="//@entries.0/@entries.2/@entries.4">
          ...
          <fertigkeiten stufe="1" fertigkeit="//@entries.0/@entries.4/@entries.3"/>
          <fertigkeiten stufe="1" fertigkeit="//@entries.0/@entries.4/@entries.8"/>
          <fertigkeiten stufe="4" fertigkeit="//@entries.0/@entries.3/@entries.3/@fertigkeiten.0"/>
          <fertigkeiten stufe="2" fertigkeit="//@entries.0/@entries.3/@entries.2/@fertigkeiten.1"/>
      ...
      <members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.4">
        <persona xsi:type="shr5:MysticAdept" name="Kyra" image="/shr5Resource/images/kablam_Girl_s_face_in_black_frame.png" edgeBasis="1" konstitutionBasis="3" geschicklichkeitBasis="6" reaktionBasis="3" staerkeBasis="2" charismaBasis="6" willenskraftBasis="4" intuitionBasis="4" logikBasis="3" spezies="//@entries.0/@entries.2/@entries.1" magieBasis="6">
    ...
    <entries xsi:type="shr5mngt:Shr5Generator" character="//@entries.1/@entries.0/@members.0" generator="//@entries.0/@entries.16/@entries.0" state="personaCreated" selectedGroup="//@entries.1/@entries.0" characterName="Gu" resourcen="//@entries.0/@entries.16/@entries.0/@priorities.46" skills="//@entries.0/@entries.16/@entries.0/@priorities.39" attribute="//@entries.0/@entries.16/@entries.0/@priorities.17" metaType="//@entries.0/@entries.16/@entries.0/@priorities.14" magic="//@entries.0/@entries.16/@entries.0/@priorities.28" karmaToResource="5"/>
