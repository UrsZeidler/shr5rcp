...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="examples">
		...
		<entries xsi:type="shr5mngt:CharacterGroup" name="player group">
			<members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.5"
				choosenLifestyle="//@entries.1/@entries.0/@members.0/@contracts.0"
				...
				<persona xsi:type="shr5:KiAdept"
					...
					<eigenschaften name="Allergy (Silver Moderate)" page="78"
				...
				<changes xsi:type="shr5mngt:PersonaChange" date="2014-02-13T22:41:55.000+0100"
					...
					from="1" to="2"
					changeable="//@entries.1/@entries.0/@members.0/@persona/@fertigkeiten.8" />
				...
				<inventar xsi:type="shr5:Nahkampfwaffe" page="422"
					...
					verfuegbarkeit="9R" name="Katana" image="/shr5Resource/images/katana.png"
				...
				<inventar xsi:type="shr5:Gegenstand" page="448"
					...
					verfuegbarkeit="2" name="Miniwelder"
      ...
      <members xsi:type="shr5mngt:PlayerCharacter" chracterSource="//@entries.1/@entries.3" choosenLifestyle="//@entries.1/@entries.1/@members.1/@contracts.1" nativeLanguage="//@entries.0/@entries.5/@entries.6" sex="male">
		...
		<entries xsi:type="shr5mngt:Shr5Generator" character="//@entries.1/@entries.1/@members.0"
			...
			selectedGroup="//@entries.1/@entries.1" characterName="Example James"
		...
		<entries xsi:type="shr5mngt:Shr5Generator" character="//@entries.1/@entries.1/@members.1"
			generator="//@entries.0/@entries.16/@entries.0" selectedGroup="//@entries.1/@entries.1"
			characterName="Rob" resourcen="//@entries.0/@entries.16/@entries.0/@priorities.45"
			...
			karmaToResource="10" />
		<entries xsi:type="shr5mngt:Shr5Generator" character="//@entries.1/@entries.1/@members.2"
			generator="//@entries.0/@entries.16/@entries.0" state="personaCreated"
			selectedGroup="//@entries.1/@entries.1" characterName="Kyra"
		...
		<entries xsi:type="shr5mngt:Shr5Generator" character="//@entries.1/@entries.0/@members.0"
			generator="//@entries.0/@entries.16/@entries.0" state="personaCreated"
			selectedGroup="//@entries.1/@entries.0" characterName="Gu"
			resourcen="//@entries.0/@entries.16/@entries.0/@priorities.46"
			skills="//@entries.0/@entries.16/@entries.0/@priorities.39"
			attribute="//@entries.0/@entries.16/@entries.0/@priorities.17"
		...
		<entries xsi:type="shr5mngt:FreeStyleGenerator" generator="//@entries.0/@entries.16/@entries.1"
