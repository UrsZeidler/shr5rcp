...
/**
 * This is the item provider adapter for a {@link de.urszeidler.shr5.scripting.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider 
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Section_titel_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Section_titel_feature", "_UI_Section_type"),
                 ScriptingPackage.Literals.SECTION__TITEL,
                 true,
                 false,
                 false,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 ScriptingPackage.Literals.SECTION__TEXT,
                 true,
                 true,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText(Object object) {
        String label = ((Section)object).getTitel();
