...
/**
 * This is the item provider adapter for a {@link de.urszeidler.shr5.scripting.Handout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HandoutItemProvider 
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Handout_type_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Handout_type_feature", "_UI_Handout_type"),
                 ScriptingPackage.Literals.HANDOUT__TYPE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addUrlPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Handout_url_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Handout_url_feature", "_UI_Handout_type"),
                 ScriptingPackage.Literals.HANDOUT__URL,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/Handout"));
    }
