...
/**
 * Entry point of the 'BoardShr5GeneratorSheet' generation module.
 *
 * @generated not
 */
public class BoardShr5GeneratorSheet extends AbstractTextGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/de/urszeidler/shr5/acceleo/sheets/boardShr5GeneratorSheet";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "boardShr5GeneratorSheetManagedCharacter" };
     ...
     * @generated
     */
    public BoardShr5GeneratorSheet() {
     ...
     * @generated
     */
    public BoardShr5GeneratorSheet(URI modelURI, File targetFolder, List<? extends Object> arguments) throws IOException {
     ...
     * @generated
     */
    public BoardShr5GeneratorSheet(EObject model, File targetFolder, List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                BoardShr5GeneratorSheet generator = new BoardShr5GeneratorSheet(modelURI, folder, arguments);
