...
public class Shr5GeneratorImpl extends CharacterGeneratorImpl implements Shr5Generator {
	...
	public void setKarmaToResource(int newKarmaToResource) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, Shr5managementPackage.SHR5_GENERATOR__KARMA_TO_RESOURCE,
					oldKarmaToResource, karmaToResource));
			eNotify(new ENotificationImpl(this, Notification.SET, Shr5managementPackage.SHR5_GENERATOR__KARMA_SPEND,
					oldKarmaToResource, karmaToResource));
		}
	}
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_CATEGORY_ONLY_ONCE, EcorePlugin.INSTANCE.getString(
								...
								new Object[] { "hasCategoryOnlyOnce", EObjectValidator.getObjectLabel(this, context) }),
						new Object[] { this }));
			}
			return false;
		}
	...
	public boolean hasNotSpendAllPoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (getShr5Generator() == null || getSkills() == null || getAttribute() == null || getResourcen() == null
				|| getMetaType() == null || getMagic() == null)
			return true;
		...
		boolean notAllSpend = haseSpendAllPoints
				...
				// || getResourcen().calcResourceSpend(getCharacter()) !=
				// getResourcen().getResource()
				...
				|| getSkills().calcSkillSpend(getCharacter()) != skillPoints
				|| getSkills().calcGroupSpend(getCharacter()) != groupPoints;
		if (notAllSpend) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_POINTS, EcorePlugin.INSTANCE.getString(
								"_UI_GenericInvariant_diagnostic",
								new Object[] { "hasNotSpendAllPoints", EObjectValidator.getObjectLabel(this, context) }),
						new Object[] { this }));
			}
			return false;
		}
			...
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_MORE_MAX_ATTRIBUTES, EcorePlugin.INSTANCE.getString(
								"_UI_GenericInvariant_diagnostic",
								new Object[] { "hasNotMoreMaxAttributes", EObjectValidator.getObjectLabel(this, context) }),
						new Object[] { this }));
			}
			return false;
		}
	...
	public boolean hasNotSpendAllAttributesPoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (getAttribute().calcAttributesSpend(getCharacter()) != getAttribute().getAttibutePoints()) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_ATTRIBUTES_POINTS, EcorePlugin.INSTANCE
								.getString("_UI_GenericInvariant_diagnostic", new Object[] { "hasNotSpendAllAttributesPoints",
	...
	public boolean hasNotSpendSkillAllPoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		int skillPoints = getSkills().getSkillPoints();
		int groupPoints = getSkills().getGroupPoints();
		if (getSkills().calcSkillSpend(getCharacter()) != skillPoints
				|| getSkills().calcGroupSpend(getCharacter()) != groupPoints) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_SKILL_ALL_POINTS, EcorePlugin.INSTANCE.getString(
								"_UI_GenericInvariant_diagnostic",
								new Object[] { "hasNotSpendSkillAllPoints", EObjectValidator.getObjectLabel(this, context) }),
						new Object[] { this }));
			}
			return false;
		}
	...
	public boolean hasNotSpendAllSpecialTypePoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (hasSpendAllPoints || getMagic().calcSkillsSpend(getCharacter()) != getMagic().getSkillNumber()) {
			if (diagnostics != null) {
				diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, Shr5managementValidator.DIAGNOSTIC_SOURCE,
						Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_SPECIAL_TYPE_POINTS, EcorePlugin.INSTANCE
								.getString("_UI_GenericInvariant_diagnostic", new Object[] { "hasNotSpendAllSpecialTypePoints",
										EObjectValidator.getObjectLabel(this, context) }), new Object[] { this }));
			}
			return false;
		}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Shr5managementValidator.SHR5_GENERATOR__HAS_NOT_SPEND_ALL_CONNECTION_POINTS,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "hasNotSpendAllConnectionPoints", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
