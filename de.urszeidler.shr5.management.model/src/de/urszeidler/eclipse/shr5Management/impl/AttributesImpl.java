...
public class AttributesImpl extends PriorityCategorieImpl implements Attributes {
    ...
    public int calcAttributesSpend(ManagedCharacter context) {
        ...
        int a = persona.getKonstitutionBasis() - spezies.getKonstitutionMin() + persona.getStaerkeBasis() - spezies.getStaerkeMin()
                + persona.getReaktionBasis() - spezies.getReaktionMin() + persona.getGeschicklichkeitBasis() - spezies.getGeschicklichkeitMin()

                + persona.getCharismaBasis() - spezies.getCharismaMin() + persona.getLogikBasis() - spezies.getLogikMin()
                + persona.getWillenskraftBasis() - spezies.getWillenskraftMin() + persona.getIntuitionBasis() - spezies.getIntuitionMin();
