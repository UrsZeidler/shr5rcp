...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.BioWare} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BioWareItemProvider
     ...
     * @generated
     */
	public BioWareItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addPersonaPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_BioWare_persona_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_BioWare_persona_feature", "_UI_BioWare_type"),
                 Shr5Package.Literals.BIO_WARE__PERSONA,
                 true,
                 false,
                 true,
                 null,
	...
	public Object getImage(Object object) {
		...
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BioWare"));
	}
	...
	public String getText(Object object) {
        String label = ((BioWare)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_BioWare_type") :
            getString("_UI_BioWare_type") + " " + label;
    }
