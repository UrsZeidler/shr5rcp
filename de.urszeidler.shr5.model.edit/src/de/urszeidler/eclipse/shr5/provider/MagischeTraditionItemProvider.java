...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.MagischeTradition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MagischeTraditionItemProvider 
     ...
     * @generated
     */
    public MagischeTraditionItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addBeschwoerbarPropertyDescriptor(object);
        }
    ...
    protected void addEnzugPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MagischeTradition_enzug_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MagischeTradition_enzug_feature", "_UI_MagischeTradition_type"),
                 Shr5Package.Literals.MAGISCHE_TRADITION__ENZUG,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
     * This adds a property descriptor for the Beschwoerbar feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addBeschwoerbarPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MagischeTradition_beschwoerbar_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MagischeTradition_beschwoerbar_feature", "_UI_MagischeTradition_type"),
                 Shr5Package.Literals.MAGISCHE_TRADITION__BESCHWOERBAR,
                 true,
                 false,
                 true,
                 null,
    ...
    /**
     * This returns MagischeTradition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated not
     */
    ...
    public Object getImage(Object object) {
        ...
        return overlayImage(object, getResourceLocator().getImage("full/obj16/MagischeTradition"));
    }
    ...
    public String getText(Object object) {
        String label = ((MagischeTradition)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_MagischeTradition_type") :
            getString("_UI_MagischeTradition_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MagischeTradition.class)) {
