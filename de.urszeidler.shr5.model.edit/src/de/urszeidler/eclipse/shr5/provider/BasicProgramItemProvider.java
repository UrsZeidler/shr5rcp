...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.BasicProgram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BasicProgramItemProvider
     ...
     * @generated
     */
    public BasicProgramItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((BasicProgram)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_BasicProgram_type") :
            getString("_UI_BasicProgram_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(BasicProgram.class)) {
