...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.MartialartStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MartialartStyleItemProvider 
     ...
     * @generated
     */
    public MartialartStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addUsableWithPropertyDescriptor(object);
        }
    ...
    protected void addTechniquesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MartialartStyle_techniques_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MartialartStyle_techniques_feature", "_UI_MartialartStyle_type"),
                 Shr5Package.Literals.MARTIALART_STYLE__TECHNIQUES,
                 true,
                 false,
                 true,
                 null,
    ...
    /**
     * This adds a property descriptor for the Usable With feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addUsableWithPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MartialartStyle_usableWith_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MartialartStyle_usableWith_feature", "_UI_MartialartStyle_type"),
                 Shr5Package.Literals.MARTIALART_STYLE__USABLE_WITH,
                 true,
                 false,
                 true,
                 null,
    ...
    /**
     * This returns MartialartStyle.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/MartialartStyle"));
    }
    ...
    public String getText(Object object) {
        String label = ((MartialartStyle)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_MartialartStyle_type") :
            getString("_UI_MartialartStyle_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MartialartStyle.class)) {
