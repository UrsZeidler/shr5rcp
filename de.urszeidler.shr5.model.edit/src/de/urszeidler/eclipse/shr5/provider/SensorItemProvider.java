...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider 
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addCapacityValuePropertyDescriptor(object);
        }
    ...
    protected void addFunctionsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Sensor_functions_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_functions_feature", "_UI_Sensor_type"),
    ...
    protected void addRatingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Sensor_rating_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_rating_feature", "_UI_Sensor_type"),
                 Shr5Package.Literals.SENSOR__RATING,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
    ...
    /**
     * This adds a property descriptor for the Capacity Value feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addCapacityValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Sensor_capacityValue_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_capacityValue_feature", "_UI_Sensor_type"),
                 Shr5Package.Literals.SENSOR__CAPACITY_VALUE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
