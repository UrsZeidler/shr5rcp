...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.MetaMagie} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaMagieItemProvider
     ...
     * @generated
     */
	public MetaMagieItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/MetaMagie"));
    }
	...
	public String getText(Object object) {
        String label = ((MetaMagie)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_MetaMagie_type") :
            getString("_UI_MetaMagie_type") + " " + label;
    }
	...
	public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MetaMagie.class)) {
