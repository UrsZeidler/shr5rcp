...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.SensorFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorFunctionItemProvider 
     ...
     * @generated
     */
    public SensorFunctionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addMaxRangePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_SensorFunction_maxRange_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_SensorFunction_maxRange_feature", "_UI_SensorFunction_type"),
                 Shr5Package.Literals.SENSOR_FUNCTION__MAX_RANGE,
                 true,
                 false,
                 false,
    ...
    /**
     * This returns SensorFunction.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated not
     */
    ...
    public Object getImage(Object object) {
        ...
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SensorFunction"));
    }
    ...
    public String getText(Object object) {
        String label = ((SensorFunction)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_SensorFunction_type") :
            getString("_UI_SensorFunction_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SensorFunction.class)) {
