...
/**
 * This is the item provider adapter for a {@link de.urszeidler.eclipse.shr5.KleindungsModifikator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KleindungsModifikatorItemProvider 
     ...
     * @generated
     */
    public KleindungsModifikatorItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addRatingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_KleindungsModifikator_rating_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_KleindungsModifikator_rating_feature", "_UI_KleindungsModifikator_type"),
                 Shr5Package.Literals.KLEINDUNGS_MODIFIKATOR__RATING,
                 true,
                 false,
                 false,
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_KleindungsModifikator_type_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_KleindungsModifikator_type_feature", "_UI_KleindungsModifikator_type"),
                 Shr5Package.Literals.KLEINDUNGS_MODIFIKATOR__TYPE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addCapacityPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_KleindungsModifikator_capacity_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_KleindungsModifikator_capacity_feature", "_UI_KleindungsModifikator_type"),
                 Shr5Package.Literals.KLEINDUNGS_MODIFIKATOR__CAPACITY,
                 false,
                 false,
                 false,
                 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
    ...
    /**
     * This returns KleindungsModifikator.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/KleindungsModifikator"));
    }
    ...
    public String getText(Object object) {
        String label = ((KleindungsModifikator)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_KleindungsModifikator_type") :
            getString("_UI_KleindungsModifikator_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(KleindungsModifikator.class)) {
